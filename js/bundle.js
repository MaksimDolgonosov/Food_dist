...
function calc() {
  ...
  var sex, height, weight, age, active;
  ...
  function firstLoad() {
    document.querySelectorAll("#gender div").forEach(function (e) {
    ...
    document.querySelector("#".concat(sex)).classList.add("calculating__choose-item_active");
    document.querySelectorAll(".calculating__choose_big div").forEach(function (e) {
      e.classList.remove("calculating__choose-item_active");
  ...
  function getStaticInformaton(parentElement, activeClass) {
    var input = document.querySelectorAll("".concat(parentElement, " div"));
...
function cards() {
  ...
  var Card = /*#__PURE__*/function () {
    function Card(image, alt, menuName, descripton, price) {
    ...
    _createClass(Card, [{
      ...
      value: function insertCard() {
        var cardsContainer = document.querySelector(".menu__field .container");
        var element = document.createElement("div"); //div.classList.add("menu__item");
        ...
        element.innerHTML = " \n        <img src=".concat(this.image, " alt=").concat(this.alt, ">\n        <h3 class=\"menu__item-subtitle\">").concat(this.menuName, "</h3>\n        <div class=\"menu__item-descr\">").concat(this.descripton, "</div>\n        <div class=\"menu__item-divider\"></div>\n        <div class=\"menu__item-price\">\n            <div class=\"menu__item-cost\">\u0426\u0435\u043D\u0430:</div>\n            <div class=\"menu__item-total\"><span>").concat(this.price, "</span> $/\u0434\u0435\u043D\u044C</div>\n        ");
      }
    }, {
      key: "changeToUsd",
      value: function changeToUsd(price) {
  ...
  (0,_services_services__WEBPACK_IMPORTED_MODULE_3__.getResourse)('http://localhost:3000/menu') // fetch('http://localhost:3000/menu')
  //.then(data => data.json())
  .then(function (res) {
...
function forms(timeoutOpenModal) {
  ...
  function bindPostData(form) {
    form.addEventListener("submit", function (element) {
      ...
      form.insertAdjacentElement("afterend", statusMessage); // statusMessage.classList.add('status');
      // statusMessage.textContent = message.loading;
      // form.appendChild(statusMessage);

      var formData = new FormData(form); // let jsonRequest = {};
  ...
  function showThanksModal(messageText) {
    var previousModal = document.querySelector(".modal__content");
    previousModal.classList.add("hide");
    (0,_modal__WEBPACK_IMPORTED_MODULE_7__.openModal)(".modal", timeoutOpenModal);
    var thanksModal = document.createElement("div");
    thanksModal.classList.add("modal__content");
    thanksModal.innerHTML = "\n<form action=\"#\">\n<div class=\"modal__close\">&times;</div>\n<div class=\"modal__title\">".concat(messageText, "</div>\n</form>\n");
...
function modal(btnsOpeSelector, modalSelector, timeoutOpenModal) {
  ...
  var btnsOpen = document.querySelectorAll(btnsOpeSelector);
  var modal = document.querySelector(modalSelector);
  ...
  btnsOpen.forEach(function (e) {
    e.addEventListener("click", function () {
      return openModal(modalSelector, timeoutOpenModal);
    });
...
/* harmony import */ var _timer__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./timer */ "./js/modules/timer.js");
...
function slider(_ref) {
  var everySlide = _ref.everySlide,
      nextArrow = _ref.nextArrow,
      previousArrow = _ref.previousArrow,
      wrapper = _ref.wrapper,
      field = _ref.field,
      container = _ref.container,
      totalCouner = _ref.totalCouner,
      currentCounter = _ref.currentCounter;
  // слайдер
  var nextBtn = document.querySelector(nextArrow);
  var prevBtn = document.querySelector(previousArrow);
  var slides = document.querySelectorAll(everySlide);
  document.querySelector(totalCouner).textContent = (0,_timer__WEBPACK_IMPORTED_MODULE_3__.getZero)(slides.length);
  var actingSlide = 0;
  document.querySelector(currentCounter).textContent = (0,_timer__WEBPACK_IMPORTED_MODULE_3__.getZero)(actingSlide + 1); // showSlide(0);
  ...
  var slidesWraper = document.querySelector(wrapper);
  var slidesField = document.querySelector(field);
  var width = window.getComputedStyle(slidesWraper).width;
  ...
  nextBtn.addEventListener("click", function () {
    ...
    document.querySelector(currentCounter).textContent = (0,_timer__WEBPACK_IMPORTED_MODULE_3__.getZero)(actingSlide + 1);
  });
  ...
  dots.forEach(function (dot, i) {
    dot.addEventListener("click", function (element) {
      //let slideIndex = i;
      var slideIndex = element.target.getAttribute("data-slide-to");
      ...
      document.querySelector(currentCounter).textContent = (0,_timer__WEBPACK_IMPORTED_MODULE_3__.getZero)(+slideIndex + 1);
    });
  });
}
...
function tabs() {
  // Табы 
  var headerList = document.querySelector(".tabheader__items");
  var tabItems = document.querySelectorAll(".tabheader__item");
  var imgHam = document.querySelectorAll(".tabcontainer img")[3];
  var tabs = document.querySelectorAll(".tabcontent");
  imgHam.src = "img/tabs/hamburger.jpg"; // tabs[3].innerHTML = `
...
window.addEventListener('DOMContentLoaded', function () {
  var timeoutOpenModal = setTimeout(function () {
    return (0,_modules_modal__WEBPACK_IMPORTED_MODULE_2__.openModal)(".modal", timeoutOpenModal);
  }, 3000);
